...
$(document).on('click', '.editar-posicion', function(e) {
    ...
    let html = `
        <div class="list-group" id="selectorTurnos">
            <button type="button" class="list-group-item list-group-item-action seleccionar-turno" data-turno-id="1" data-posicion-id="${posicion_id}">
                <i class="fas fa-sun mr-2"></i> Editar Desayuno
            </button>
            <button type="button" class="list-group-item list-group-item-action seleccionar-turno" data-turno-id="2" data-posicion-id="${posicion_id}">
                <i class="fas fa-utensils mr-2"></i> Editar Comida
            </button>
            <button type="button" class="list-group-item list-group-item-action seleccionar-turno" data-turno-id="3" data-posicion-id="${posicion_id}">
...
$(document).on('click', '.seleccionar-turno', function() {
    ...
    Swal.close();
    // Guardar en inputs ocultos del modal
